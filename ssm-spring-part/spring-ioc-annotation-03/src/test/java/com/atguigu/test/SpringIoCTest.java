...
public class SpringIoCTest {
    ...
    public void testIoc_01(){
        ...
        Object xxxService = applicationContext.getBean(XxxService.class);
    ...
    public void testIoc_03(){
        ...
        //场景2：ioc容器没用默认的类型如何处理
        // @Autowired 使用它进行装配，[默认]情况下至少要求有一个bean！否则报错！可以指定佛系装配

        //场景3：同一个类型有多个对应的组件@Autowired也会报错！无法选择！！
        //解决1：成员属性名指定@Autowired多个组件的时候，默认会根据成员属性名查找
        //解决2：@Qualifier(value = "userServiceImpl")使用该注解来指定获取bean的id！不能单独使用必须配合autowired
